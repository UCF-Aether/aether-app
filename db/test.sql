...
select * from device;
insert into device (profile_id, name, aws_device_id, bme_config, bme_state) VALUES
(
 '00000000-0000-0000-0000-000000000000', 'Test device', '0', '{}'::json, '{}'::json
);
select * from device;
...
select * from new_reading(1, 'O3', now(), 420.69);
