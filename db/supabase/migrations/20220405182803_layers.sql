...
values ('REL_HUMIDITY', 'rel_humidity_view', '{"REL_HUMIDITY"}', 'hourly_reading_stats'),
       ('TEMPERATURE', 'temperature_view', '{"TEMPERATURE"}', 'hourly_reading_stats'),
       ('PRESSURE', 'pressure_view', '{"PRESSURE"}', 'hourly_reading_stats'),
       ('CO2', 'co2_view', '{"CO2"}', 'hourly_reading_stats'),
       ('VOC', 'voc_view', '{"VOC"}', 'hourly_reading_stats'),
       ('O3', 'o3_view', '{"O3"}', 'hourly_reading_stats'),
       ('NO2', 'no2_view', '{"NO2"}', 'hourly_reading_stats'),
       ('PM2_5', 'pm2_5_view', '{"PM2_5"}', 'hourly_reading_stats'),
       ('PM10', 'pm10_view', '{"PM10"}', 'hourly_reading_stats'),
